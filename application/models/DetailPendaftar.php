        ...
        <form id="preForm" class="m-t" role="form">
            ...
            <div class="col-md-6 mb-2">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="alamat" name="alamat" <?= empty($ret_data['alamat']) ? ' required="required"' : '' ?>>
                </div>
                <?= !empty($ret_data['alamat']) ? '<img style="width : 250px; height: 150px" src="' . base_url('upload/ktp/') . $ret_data['alamat'] . '">' : '' ?>
            </div>

            <div class="col-md-6 mb-2">
                <div class="form-group">
                    <label>SWA Foto<small style="color: red"> *max 300kb</small></label>
                    <input type="file" class="form-control" id="swa_foto" name="swa_foto" <?= empty($ret_data['swa_foto']) ? ' required="required"' : '' ?>>
                </div>
